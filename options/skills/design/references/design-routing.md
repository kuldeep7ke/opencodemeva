...
**Tokens:**
```bash
node ~/.config/opencode/skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node ~/.config/opencode/skills/design-system/scripts/validate-tokens.cjs -d src/
```
