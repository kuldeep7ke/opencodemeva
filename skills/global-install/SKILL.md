...
$ opencode-agent-kit init --global
  ...
  Installed:
    ...
    • memory (global) — Persistent memory index
...
| `mcp.*.command[]` | `.opencode/hooks/memory-start.mjs` | `/Users/user/.config/opencode/hooks/memory-start.mjs` |
| `plugin[]` | `.opencode/plugins/memory-capture.ts` | `/Users/user/.config/opencode/plugins/memory-capture.ts` |
