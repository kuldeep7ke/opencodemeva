...
## Core Identity
Opencode Patch is a production-ready extension for opencode: specialized agents, on-demand skills, slash commands, rules, and automated hook workflows for software development.
